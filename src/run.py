...
def parse_arguments():
    ...
    # parallelism
    parser.add_argument("--n_sub_batch", type=int, default=2, help="per-gpu batch size")
    ...
    # generate
    parser.add_argument("--gen_dataset_size", type=int, default=16, help="per-gpu batch size")
